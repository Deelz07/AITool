...
OUTPUT_FILE = OUTPUT_DIR / "surds_handout.tex"
...
def generate_questions_worksheet(client: genai.Client, input_path: Path, output_path: Path) -> None:
    ...
    2. Remove any excessive formatting from other maths language. E.g. [\color[rgb]{0.35,0.35,0.35}6 = 2+r\] should be converted
        to latex version of that.

    4.Format it such that questions are marked with new queston numbers and subpart are marked with letters.
    ...
    6. Additionally please add a title to the worksheet! (Make it the topic being covered)
    """
...
if __name__ == "__main__":
    client = setup_client()
    generate_questions_worksheet(client, INPUT_PATH, OUTPUT_FILE)
